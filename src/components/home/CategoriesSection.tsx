...
const categories = [
  { name: "DJ & Musique", slug: "dj", image: categoryDj, count: 85 },
  { name: "Photographes", slug: "photo", image: categoryPhoto, count: 120 },
  { name: "Traiteurs", slug: "traiteur", image: categoryTraiteur, count: 65 },
  { name: "Décoration", slug: "deco", image: categoryDeco, count: 78 },
  { name: "Wedding Planners", slug: "planner", image: categoryPlanner, count: 45 },
  { name: "Tenues traditionnelles", slug: "tenues", image: categoryTenues, count: 92 },
  { name: "Beauté", slug: "beaute", image: categoryBeaute, count: 58 },
];
