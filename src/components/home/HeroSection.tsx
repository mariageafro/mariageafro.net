  ...
  return (
    <section className="relative min-h-[100svh] sm:min-h-[85vh] flex items-center justify-center z-0 overflow-visible">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-b from-chocolate/50 via-chocolate/40 to-chocolate/60 sm:from-chocolate/50 sm:via-chocolate/35 sm:to-chocolate/65" />
      </div>
