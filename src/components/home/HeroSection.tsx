...
export function HeroSection() {
  return (
    <>
      {/* Hero visual + text */}
      <section className="relative min-h-[70vh] sm:min-h-[85vh] flex items-center justify-center z-0 overflow-visible">
        {/* Background Image */}
        ...
        <div className="relative z-10 container-editorial pt-28 pb-12 overflow-visible">
          <div className="max-w-4xl mx-auto text-center overflow-visible">
            ...
            {/* Search Bar — desktop only (inside hero) */}
            <motion.div
              initial={{ opacity: 0, y: 24 }}
              animate={{ opacity: 1, y: 0 }}
      ...
      {/* Search Bar — mobile only (below hero image) */}
      <div className="sm:hidden px-4 -mt-6 relative z-10">
        <motion.div
          initial={{ opacity: 0, y: 16 }}
          animate={{ opacity: 1, y: 0 }}
